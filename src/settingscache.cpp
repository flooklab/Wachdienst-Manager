 ...
 * DatabaseCache::populate() will be called (forwarding the \p pLockFile and \p pForce arguments).
 *
 ...
 */
bool SettingsCache::populate(std::shared_ptr<QLockFile> pLockFile, bool pForce)
{
    if (populated && !pForce)
        return true;
 ...
 */
int SettingsCache::getIntSetting(const QString& pSetting, bool pNoMsgBox)
{
    if (pSetting == "app_export_autoOnSave")
        return getAutoExportOnSave(pNoMsgBox);
    else if (pSetting == "app_export_autoOnSave_askForFileName")
        return getAutoExportOnSaveAskFileName(pNoMsgBox);
    else if (pSetting == "app_export_twoSidedPrint")
        return getTwoSidedPrint(pNoMsgBox);
    else if (pSetting == "app_default_station")
 ...
 * \throws std::invalid_argument Integer type setting \p pSetting does not exist.
 */
bool SettingsCache::setIntSetting(const QString& pSetting, int pValue)
{
    if (pSetting == "app_export_autoOnSave")
        return setAutoExportOnSave(pValue);
    else if (pSetting == "app_export_autoOnSave_askForFileName")
        return setAutoExportOnSaveAskFileName(pValue);
    else if (pSetting == "app_export_twoSidedPrint")
        return setTwoSidedPrint(pValue);
    else if (pSetting == "app_default_station")
 ...
 */
double SettingsCache::getDblSetting(const QString& pSetting, bool pNoMsgBox)
{
    (void)pNoMsgBox;    //Suppress unused variable warning; TODO: remove this, once a floating-point setting is added
 ...
 * \throws std::invalid_argument Floating-point type setting \p pSetting does not exist.
 */
bool SettingsCache::setDblSetting(const QString& pSetting, double pValue)
{
    (void)pValue;   //Suppress unused variable warning; TODO: remove this, once a floating-point setting is added
 ...
 */
QString SettingsCache::getStrSetting(const QString& pSetting, bool pNoMsgBox)
{
    if (pSetting == "app_export_xelatexPath")
        return getXeLaTeXPath(pNoMsgBox);
    else if (pSetting == "app_export_fontFamily")
        return getPDFFont(pNoMsgBox);
    else if (pSetting == "app_auth_hash")
        return getPasswordHash(pNoMsgBox);
    else if (pSetting == "app_auth_salt")
        return getPasswordSalt(pNoMsgBox);
    else if (pSetting == "app_default_fileDialogDir")
        return getDefaultDirectory(pNoMsgBox);
    else if (pSetting == "app_default_dutyTimeBegin")
        return getDutyTimeBegin(pNoMsgBox);
    else if (pSetting == "app_default_dutyTimeEnd")
        return getDutyTimeEnd(pNoMsgBox);
    else if (pSetting == "app_documentLinks_documentList")
        return getDocumentLinkList(pNoMsgBox);
    else
...
{
    if (pSetting == "app_export_xelatexPath")
        return setXeLaTeXPath(pValue);
    else if (pSetting == "app_export_fontFamily")
        return setPDFFont(pValue);
    else if (pSetting == "app_auth_hash")
        return setPasswordHash(pValue);
    else if (pSetting == "app_auth_salt")
        return setPasswordSalt(pValue);
    else if (pSetting == "app_default_fileDialogDir")
        return setDefaultDirectory(pValue);
    else if (pSetting == "app_default_dutyTimeBegin")
        return setDutyTimeBegin(pValue);
    else if (pSetting == "app_default_dutyTimeEnd")
        return setDutyTimeEnd(pValue);
    else if (pSetting == "app_documentLinks_documentList")
        return setDocumentLinkList(pValue);
    else
        throw std::invalid_argument("Invalid string type setting \"" + pSetting.toStdString() + "\"");
 ...
 * \throws std::invalid_argument Integer type setting \p pSetting does not exist.
 */
bool SettingsCache::getBoolSetting(const QString& pSetting, bool pNoMsgBox)
{
 ...
 * \throws std::invalid_argument Integer type setting \p pSetting does not exist.
 */
bool SettingsCache::setBoolSetting(const QString& pSetting, bool pValue)
{
 ...
 * \return Value of the setting.
 */
int SettingsCache::getAutoExportOnSave(bool pNoMsgBox)
{
    int tValue = 0;
 ...
 * \return If writing to database was successful.
 */
bool SettingsCache::setAutoExportOnSave(int pValue)
{
 ...
 * \return Value of the setting.
 */
int SettingsCache::getAutoExportOnSaveAskFileName(bool pNoMsgBox)
{
    int tValue = 0;
 ...
 * \return If writing to database was successful.
 */
bool SettingsCache::setAutoExportOnSaveAskFileName(int pValue)
{
 ...
 * \return Value of the setting.
 */
int SettingsCache::getTwoSidedPrint(bool pNoMsgBox)
{
    int tValue = 0;
 ...
 * \return If writing to database was successful.
 */
bool SettingsCache::setTwoSidedPrint(int pValue)
{
 ...
 * \return Value of the setting.
 */
int SettingsCache::getDefaultStation(bool pNoMsgBox)
{
    int tValue = 0;
 ...
 * \return If writing to database was successful.
 */
bool SettingsCache::setDefaultStation(int pValue)
{
 ...
 * \return Value of the setting.
 */
int SettingsCache::getDefaultBoat(bool pNoMsgBox)
{
    int tValue = 0;
 ...
 * \return If writing to database was successful.
 */
bool SettingsCache::setDefaultBoat(int pValue)
{
 ...
 * \return Value of the setting.
 */
QString SettingsCache::getXeLaTeXPath(bool pNoMsgBox)
{
    QString tValue;
    ...
    if (tValue != "" && !QFileInfo::exists(tValue))
    {
        if (!pNoMsgBox)
        {
            QMessageBox(QMessageBox::Warning, "Warnung", "XeTeX-Pfad existiert nicht!", QMessageBox::Ok).exec();
        }
    }
    return tValue;
}
 ...
 * \return Value of the setting.
 */
QString SettingsCache::getPDFFont(bool pNoMsgBox)
{
    QString tValue;
 ...
 * \return Value of the setting.
 */
QString SettingsCache::getPasswordHash(bool pNoMsgBox)
{
    QString tValue;
 ...
 * \return Value of the setting.
 */
QString SettingsCache::getPasswordSalt(bool pNoMsgBox)
{
    QString tValue;
 ...
 * \return Value of the setting.
 */
QString SettingsCache::getDefaultDirectory(bool pNoMsgBox)
{
    QString tValue;
 ...
 * \return Value of the setting.
 */
QString SettingsCache::getDutyTimeBegin(bool pNoMsgBox)
{
    QString tValue;
 ...
 * \return Value of the setting.
 */
QString SettingsCache::getDutyTimeEnd(bool pNoMsgBox)
{
    QString tValue = "";
 ...
 * \return Value of the setting.
 */
QString SettingsCache::getDocumentLinkList(bool pNoMsgBox)
{
    QString tValue;
