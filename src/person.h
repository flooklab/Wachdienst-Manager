...
/*!
 * \brief Information about a person of (internal or external) personnel or non-personnel.
 *
 ...
 *
 * Person identifiers are distinguished between internal (from personnel database) identifiers,
 * external (guest personnel) identifiers and "other" (non-personnel guests) identifiers.
 * Internal identifiers are based on the person's association membership number and can be
 * generated by createInternalIdent(). External identifiers should not rely on a membership number.
 * They are thus based on a hash generated from name and qualifications and can be generated by createExternalIdent().
 * Similarly, "other" identifiers are based on a hash generated from the name only and can be generated by createOtherIdent().
 *
...
public:
    Person(QString pLastName, QString pFirstName, QString pIdent, Qualifications pQualifications, bool pActive);    ///< Constructor.
    //
    ...
    static QString createExternalIdent(const QString& pLastName, const QString& pFirstName,
                                       const Qualifications& pQualifications, const QString& pSuffix);
                                                                                                ///< \brief Create person identifier
                                                                                                ///  for external personnel.
    static QString createLegacyExternalIdent(const QString& pLastName, const QString& pFirstName,
                                             const QString& pQualifications, const QString& pSuffix);
                                                                                                ///< \brief Create legacy person
                                                                                                ///  identifier for external personnel.
    static QString createOtherIdent(const QString& pLastName, const QString& pFirstName, const QString& pSuffix);
                                                                                                ///< \brief Create person identifier
                                                                                                ///  for "other" people.
    //
    static bool isInternalIdent(const QString& pIdent);                                         ///< \brief Check if person identifier
                                                                                                ///  represents an internal person.
    static bool isExternalIdent(const QString& pIdent);                                         ///< \brief Check if person identifier
                                                                                                ///  represents an external person.
    static bool isOtherIdent(const QString& pIdent);                                            ///< \brief Check if person identifier
                                                                                                ///  represents an "other" person.
    //
    ...
    static QString extractExtSuffix(const QString& pExternalIdent);                             ///< \brief Extract suffix from external
                                                                                                ///  or "other" person identifier.
    //
    ...
    Qualifications getQualifications() const;           ///< Get the person's qualifications.
...
private:
    static QString createHashedIdent(const QString& pLastName, const QString& pFirstName, const QString& pQualifications,
                                     char pPrefix, QString pSuffix);            ///< Create a hashed person identifier.
...
public:
    ...
    struct Qualifications
    {
        ...
        //
        static QString convertLegacyQualifications(const QString& pQualifications); ///< Convert qualifications from old to new format.
        //
        QString toString() const;                           ///< Get a comma-separated list of possessed qualifications.
        //
        bool eh,    ///< "Erste-Hilfe-Lehrgang".
             drsaS, ///< "Deutsches Rettungsschwimmabzeichen Silber".
             sanA,  ///< "Sanitätshelfer".
             faWrd, ///< "Fachausbildung Wasserrettungsdienst".
             bfA,   ///< "Bootsführerschein A (Binnen)".
             bfB,   ///< "Bootsführerschein B (See)".
             bos,   ///< "BOS-Sprechfunker".
             sr1,   ///< "Strömungsretter 1".
             et,    ///< "Einsatztaucher Stufe 1 oder Stufe 2".
             wf,    ///< "Wachführer".
             zf;    ///< "Zugführer".
    };
    //
    ...
    enum class BoatFunction : int8_t
    {
        ...
        _EXT = 100,     ///< External ("other") people not part of duty personnel.
        _OTHER = 127    ///< Reserved.
    };
...
public:
     ...
     *
     * For each standard 'BoatFunction' the \p pFunction is called with first parameter being 'BoatFunction'
...
private:
    ...
    Qualifications qualifications;  //Qualifications of the person
